...
import PickupRequestTable from "./Tables/RegularTables/TransporterRequestTable.vue";
...
export default {
  ...
  mounted() {
    ...
    axios
      .get(`https://truckstation.info/api/pickups/transporter`, {
        headers: {
