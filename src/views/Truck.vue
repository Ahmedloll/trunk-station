...
export default {
  ...
  methods: {
    onSubmit() {
      let data = {
        id: this.truck.id.toString(10),
        truckLocation: this.truck.truckLocation,
        type: this.truck.type,
        capacity: this.truck.capacity,
        licenseExpiryDate: this.truck.licenseExpiryDate,
        registrationNo: this.truck.registrationNo,
        priceKM: this.truck.priceKM,
        returnPriceKM: this.truck.returnPriceKM,
  ...
  mounted() {
    ...
    axios
      ...
      .then(response => {
        this.truck = response.data.data;
        this.truck.truckLocation = this.truck.truckLocation.id;
        this.truck.type = this.truck.type.id;
        this.loader = false;
      });
  }
};
